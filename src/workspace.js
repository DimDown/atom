  ...
  */
  ...
  open (uri_, options = {}) {
    ...
    return Promise.resolve(item)
      .then(item => this.openItemInPane(item, pane, Object.assign({uri}, options)))
  }
  ...
  openURIInPane (uri, pane, options = {}) {
    ...
    return this.openItemInPane(item, pane, Object.assign({uri}, options))
  }

  openItemInPane (item, pane, options = {}) {
